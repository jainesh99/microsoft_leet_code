...
class Solution:
    ...
    def get_available_positions(self, grid, position, number_of_rows, number_of_columns):
    ...
    def getFood(self, grid: List[List[str]]) -> int:
        ...
        while bfs_queue:
            ...
            available_positions = self.get_available_positions(grid, position, num_of_rows, num_of_columns)
